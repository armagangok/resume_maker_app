...
void initDependencies() {
  ...
  getIt.registerLazySingleton<AcademicDataRepositoryImp>(
  ...
  getIt.registerLazySingleton<ImagePickerRepositoryImp>(
      () => ImagePickerRepositoryImp());

  getIt.registerLazySingleton<PersonalDataRepositoryImp>(
